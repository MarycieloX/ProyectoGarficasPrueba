...
// -------------------
// Descripción: Constructor que inicializa los componentes del terreno
// -------------------
Terrain::Terrain() :
...
// -------------------
// Descripción: Destructor que desasigna la memoria asignada en el montón
// -------------------
Terrain::~Terrain()
{}

// -------------------
// Descripción: Función que crea el programa shader del terreno e inicializa las texturas del terreno
// -------------------
...
// -------------------
// Descripción: función que lee un mapa de altura (una cuadrícula de valores 2D) y envía los datos a la GPU
// -------------------
...
// -------------------
// Descripción: función que crea un mapa de altura (procedimentalmente) utilizando el algoritmo Perlin Noise
// -------------------
void Terrain::CreateTerrainWithPerlinNoise()
{
	// Establecer la semilla del ruido para que sea diferente cada vez.
...
// -------------------
// Descripción: Función que calcula las normales del terreno
// -------------------
...
// -------------------
// Descripción: Función que obtiene las alturas de las grillas del terreno
// -------------------
float Terrain::GetHeightOfTerrain(float _X, float _Z)
{
	...
	// Triángulo superior del quad, de lo contrario, el triángulo inferior del quad
	if (xCoord <= (1 - zCoord))
	{
...
// -------------------
// Descripción: función de ayuda utilizada para encontrar la altura de un triángulo en el que se encuentra actualmente el jugador
// -------------------
...
// -------------------
// Descripción: función que vincula el objeto de matriz de vértices de terreno (VAO) y dibuja sus datos de vértice
// -------------------
void Terrain::Draw(Camera& _cam, DirectionalLight* directionLight, PointLight* lamp, SpotLight* spotlight)
{
	...
	// Activa todas las texturas
	for (unsigned int i = 0; i < 6; ++i)
		m_terrainTexture.ActivateTextures(i);

	// Matriz de transformación de MVP
