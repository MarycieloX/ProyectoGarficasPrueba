...
void Atmosphere::Update(float dt)
{
	...
	if (m_nightMode)
	{
		...
		// Desactivar la probabilidad de tormentas eléctricas cuando es casi de mañana (desactivar casi al "amanecer")
		if (m_dayTimer <= 0.15f)
...
void Atmosphere::Thunderstorm()
{
	...
	{
		// Genere una duración para destellos de tormenta y reproduzca sonido de tormenta
